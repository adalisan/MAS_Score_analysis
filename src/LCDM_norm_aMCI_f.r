...
pdf(file=paste("test_results_aMCI_f/summarystat_",REGION,".pdf",sep=''))
...
legend(5, .3, paste(c('normal','aMCI','nMCI'),sep=", "), cex=1,  col= c('black','red','blue'),lwd=2, bty="n");
...
file1=paste("pooled_antsy_files/",REGION,"_normal_f_wave1_pooled_antsy.txt",sep='')
file2=paste("pooled_antsy_files/",REGION,"_nonamnesticMCI_f_wave1_pooled_antsy.txt",sep='')
file3=paste("pooled_antsy_files/",REGION,"_amnesticMCI_f_wave1_pooled_antsy.txt",sep='')
...
OUTFILE=paste("/cis/project/sydney/pooled_analysis/test_results_aMCI_f/result_",REGION,".txt",sep='')
