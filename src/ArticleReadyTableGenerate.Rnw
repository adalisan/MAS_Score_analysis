...
<<Pooled_Stat_Tests>>=
 side =  c("lh","rh")
  ...
  cond_1_fileh <- open(file = paste0(DATA_DIR,"/",side,'_',region,"_",cond_1,"_wave1_pooled_antsy.txt"))
  cond_2_fileh <- open(file = paste0(DATA_DIR,"/",side,'_',region,"_",cond_2,"_wave1_pooled_antsy.txt"))
