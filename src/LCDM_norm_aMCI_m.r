...
pdf(file=paste("test_results_aMCI_m/summarystat_",REGION,".pdf",sep=''))
...
file1=paste("pooled_antsy_files/",REGION,"_normal_m_wave1_pooled_antsy.txt",sep='')
file2=paste("pooled_antsy_files/",REGION,"_nonamnesticMCI_m_wave1_pooled_antsy.txt",sep='')
file3=paste("pooled_antsy_files/",REGION,"_amnesticMCI_m_wave1_pooled_antsy.txt",sep='')
...
OUTFILE=paste("/cis/project/sydney/pooled/test_results_aMCI_m/result_",REGION,".txt",sep='')
