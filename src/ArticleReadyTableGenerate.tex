...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in aov.result\$`Pr(>F)`: \$ operator is invalid for atomic vectors}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in paste(Covariate\_names, "{}(p = "{}, p\_vals, "{})"{}, sep = "{}"{}): object 'p\_vals' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'cov\_column' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in aov.result\$`Pr(>F)`: \$ operator is invalid for atomic vectors}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'cov\_column\_2' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in data.frame(Covariate = cov\_column, p.value = cov\_column\_2): object 'cov\_column' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in cbind(print.table.df, print.table2.df[, 2:3], cov\_test\_cols): object 'cov\_test\_cols' not found}}\end{kframe}
